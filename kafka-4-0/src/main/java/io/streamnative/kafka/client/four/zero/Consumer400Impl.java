 ...
 */
package io.streamnative.kafka.client.four.zero;
...
/**
 * The implementation of Kafka consumer 4.0.0.
 */
public class Consumer400Impl<K, V> extends KafkaConsumer<K, V> implements Consumer<K, V> {

    public Consumer400Impl(final ConsumerConfiguration conf) {
