...
/**
 * Testing the SASL-PLAIN features on KoP with `entry.format=pulsar` and Proxy.
 */
public class SaslPlainPulsarProxyTest extends SaslPlainTestBase {

    public SaslPlainPulsarProxyTest() {
        super("pulsar");
    }
